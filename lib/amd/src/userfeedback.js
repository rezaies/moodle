 ...
 * @param {boolean} [record=true] Whether to record the action or not
 * @returns {Promise<void>}
 */
const giveFeedback = async(contextId, record = true) => {
    let request = {
    ...
    const surveyUrl = data.feedbackurl +
        '?lang=' + data.lang +
