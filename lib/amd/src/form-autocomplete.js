    ...
    var addNavigation = function(options, state, originalSelect) {
        ...
        inputElement.on('blur', function() {
            ...
            window.setTimeout(function() {
                ...
                // Only close the menu if the input hasn't regained focus, and regain focus if the scrollbar is clicked.
                if (focusElement.attr('id') == inputElement.attr('list')) {
                    inputElement.focus(); // Probably the scrollbar is clicked. Regain focus.
                } else if (focusElement.attr('id') != inputElement.attr('id')) {
                    if (options.tags) {
