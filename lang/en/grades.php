...
$string['studentsperpageoptions'] = 'Students per page options';
$string['studentsperpageoptions_help'] = 'This setting determines the available options in the "Students per page" dropdown menu. You can enter multiple numbers and separate them by commas without any spaces in between.';
$string['studentsperpage_help'] = 'This setting determines the default number of students displayed per page in the grader report. Enter a number that is within the "Students per page options" list.';
