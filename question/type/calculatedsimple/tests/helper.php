...
class qtype_calculatedsimple_test_helper extends question_test_helper {
    ...
    public function get_calculatedsimple_question_data_sumwithvariants() {
        ...
        $q->options->correctfeedback = get_string('correctfeedbackdefault', 'question');
        $q->options->partiallycorrectfeedback = get_string('partiallycorrectfeedbackdefault', 'question');
        $q->options->incorrectfeedback = get_string('incorrectfeedbackdefault', 'question');
