...
class qtype_calculated_test_helper extends question_test_helper {
    ...
    public function get_calculated_question_data_sum() {
        ...
        $qdata->options->answers = [
            13 => new get_calculated_question_data_sum(13, '{a} + {b}', 1.0, 'Very good.', FORMAT_HTML, 0.001),
            14 => new get_calculated_question_data_sum(14, '{a} - {b}', 0.0, 'Add. not subtract!.', FORMAT_HTML, 0.001),
            17 => new get_calculated_question_data_sum(17, '*', 0.0, 'Completely wrong.', FORMAT_HTML, 0),
        ];
