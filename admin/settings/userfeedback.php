...
if ($hassiteconfig) {
    ...
    $options = [
        USERFEEDBACK_AFTER_UPGRADE => new lang_string('userfeedbackafterupgrade', 'admin'),
        USERFEEDBACK_PERIODICALLY => new lang_string('userfeedbackperiodically', 'admin'),
        USERFEEDBACK_NEVER => new lang_string('never'),
    ];
