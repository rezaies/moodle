...
$string['mod_lti:activityplacement_description'] = 'Lets you add an external tool as a new activity option in your course.';
...
$string['privacy:metadata'] = 'The External tool plugin does not store any personal data.';
