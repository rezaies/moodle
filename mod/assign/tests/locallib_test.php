...
class locallib_test extends \advanced_testcase {
    ...
    public function test_gradingtable_group_submissions_rendering(): void {
        ...
        $this->assertSame(get_string('submissionstatus_submitted', 'assign'),
            $xpath->evaluate('string(//td[@id="' . $xpathuniqueidroot . '_r0_c3"]//div[@class="submissionstatustext submissionstatussubmitted"])'));
        $this->assertSame(get_string('submissionstatus_submitted', 'assign'),
            $xpath->evaluate('string(//td[@id="' . $xpathuniqueidroot . '_r3_c3"]//div[@class="submissionstatustext submissionstatussubmitted"])'));
