...
class mod_assign_locallib_testcase extends mod_assign_base_testcase {
    ...
    public function test_gradingtable_extension_due_date() {
        ...
        $this->add_submission($assign, $this->students[0]->id, $data, 'onlinetext');
    ...
    public function test_delete_instance() {
        ...
        $data->onlinetext_editor = array('itemid'=>file_get_unused_draft_itemid(),
                                         'text'=>'Submission text',
                                         'format'=>FORMAT_MOODLE);
        $this->add_submission($assign, $this->students[0]->id, $data, 'onlinetext', false);
...
";
    ...
    public function test_update_grade() {
        ...
        foreach ([$assign1, $assign2] as $assign) {
            ...
            $this->add_submission($assign, $studentid, $data, 'onlinetext');
