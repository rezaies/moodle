...
class dates_test extends advanced_testcase {
        ...
        return [
            ...
            'only with closing time' => [
                null, $after, null, null, null, null, [
                    ['label' => 'Submissions due:', 'timestamp' => $after],
                ]
            ],
            'with both times' => [
                $after, $later, null, null, null, null, [
                    ['label' => 'Submissions open:', 'timestamp' => $after],
                    ['label' => 'Submissions due:', 'timestamp' => $later],
                ]
            ],
            'between the dates' => [
                $before, $after, null, null, null, null, [
                    ['label' => 'Submissions opened:', 'timestamp' => $before],
                    ['label' => 'Submissions due:', 'timestamp' => $after],
                ]
            ],
            'dates are past' => [
                $earlier, $before, null, null, null, null, [
                    ...
                    ['label' => 'Submissions due:', 'timestamp' => $before],
                ]
            ],
            'with user override' => [
    ...
    public function test_get_dates_for_module(?int $from, ?int $due,
        ...
        $assign = $this->getDataGenerator()->create_module('assign', $data);
