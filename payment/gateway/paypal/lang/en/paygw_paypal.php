...
$string['privacy:metadata:brandname'] = 'The brand name that is sent to PayPal as the seller\'s brand.';
$string['privacy:metadata:clientid'] = 'PayPal client ID.';
$string['privacy:metadata:paypal_js_sdk'] = 'The PayPal payment gateway plugin transmits user data from Moodle to PayPal JavaScript SDK.';
$string['privacy:metadata:paygw_paypal'] = 'Information about the PayPal transactions.';
$string['privacy:metadata:paygw_paypal:pp_orderid'] = 'The ID of the order in PayPal.';
