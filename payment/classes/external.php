...
class external extends external_api {
     ...
     */
    public static function get_gateways_supporting_currency_parameters(): external_function_parameters {
     ...
     * @return \stdClass[]
     */
    public static function get_gateways_supporting_currency(string $currency): array {

        $params = external_api::validate_parameters(self::get_gateways_supporting_currency_parameters(), [
            'currency' => $currency,
        ]);

        $list = [];
        $gateways = helper::get_gateways_supporting_currency($params['currency']);
     ...
     */
    public static function get_gateways_supporting_currency_returns(): external_multiple_structure {
