...
class cmitem implements renderable, templatable {
    ...
    public function export_for_template(\renderer_base $output): stdClass {
        ...
        $cmformatdisplayoptions = $this->displayoptions;
        $cmformatdisplayoptions['showactivityconditions'] = $showactivityconditions;
        $cmformatdisplayoptions['showactivitydates'] = $showactivitydates;
