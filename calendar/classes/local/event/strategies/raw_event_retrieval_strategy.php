    ...
    protected function get_raw_events_legacy_implementation(
        ...
        if (is_array($users)) {
            foreach ($users as $userid) {
                ...
                $usercourses = calendar_get_default_courses(null, '*', false, $userid);

                // Set calendar filters.
                list($usercourses, $usergroups, $user) = calendar_set_filters($usercourses, true, $userid);
                ...
                if ($user) {
                    ...
                    foreach ($usercourses as $courseid) {
                        if (has_capability('moodle/site:accessallgroups', \context_course::instance($courseid), $userid)) {
