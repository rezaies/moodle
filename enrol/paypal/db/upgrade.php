...
function xmldb_enrol_paypal_upgrade($oldversion) {
    ...
    if ($oldversion < 2017051502) {
        ...
        // Paypal savepoint reached.
        upgrade_plugin_savepoint(true, 2017051502, 'enrol', 'paypal');
    }
    ...
    if ($oldversion < 2017051503) {
        ...
        // Paypal savepoint reached.
        upgrade_plugin_savepoint(true, 2017051503, 'enrol', 'paypal');
    }
    ...
    if ($oldversion < 2017051504) {
        ...
        // Paypal savepoint reached.
        upgrade_plugin_savepoint(true, 2017051504, 'enrol', 'paypal');
    }
    ...
    if ($oldversion < 2017051505) {
        ...
        // Paypal savepoint reached.
        upgrade_plugin_savepoint(true, 2017051505, 'enrol', 'paypal');
    }
