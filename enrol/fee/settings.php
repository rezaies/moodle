...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configcheckbox('enrol_fee/mailstudents', get_string('mailstudents', 'enrol_fee'), '', 0));

    $settings->add(new admin_setting_configcheckbox('enrol_fee/mailteachers', get_string('mailteachers', 'enrol_fee'), '', 0));

    $settings->add(new admin_setting_configcheckbox('enrol_fee/mailadmins', get_string('mailadmins', 'enrol_fee'), '', 0));
    ...
    $currencies = enrol_get_plugin('fee')->get_currencies();
